...
namespace IT__Inventory
{
    public partial class Scanout_Report : Form
    {
        ...
        string query = "SELECT * FROM IT_INVENTORY WHERE STATUS = 'SCAN_OUT' AND DATE BETWEEN @StartDate AND @EndDate";
